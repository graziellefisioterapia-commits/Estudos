programa {
  ...
  //Constantes Globais Definido Parâmetros da Caçada
  ...
  escreva("Tempo total gasto na caçada (em horas, ex: 1.5 para 1h30min): ")leia(tempo_gasto_horas)
  ...
  gp_total_coletado = quantidade_monstros_derrotados
